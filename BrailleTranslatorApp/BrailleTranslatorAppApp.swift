...
struct BrailleApp: App {
    ...
    private static let curriculumData: [(day: Int, title: String, subtitle: String)] = [
        ...
        (11, "'ㅏ' 생략 약자",
             "고유 약자(가, 사, 까, 싸) 익히기"),
        (12, " 'ㅏ' 생략 약자의 예외 법칙",
             "무조건 'ㅏ'를 살려야 하는 '라, 차', 약자 뒤에 모음이 올 때 혼동을 막기 위한 예외 규정"),
        (13, "모음+받침 약자 1 (억, 언, 얼, 연, 열, 영)",
             "'ㅓ, ㅕ' 계열의 묶음 약자 점형 익히기"),
        (14, "모음+받침 약자 2 및 특수 약자",
             "나머지 묶음 약자(옥, 온, 옹 / 운, 울 / 은, 을, 인)/것 익히기"),
        (15, "7개 약어 (접속사)",
             "모두 1점으로 시작하는 7개 마법의 접속사(그래서, 그러나, 그러면, 그러므로, 그런데, 그리고, 그리하여) 익히기"),
        // 4주차: 영어 알파벳과 실생활
        (16, "영어 알파벳 기초 (A~J)",
             "a~j 점형이 숫자 0~9과 동일한 원리"),
        (17, "영어 알파벳 기초 2 (K~Z)",
             "나머지 알파벳과 대문자 기호표"),
        (18, "필수 문장 부호",
             "마침표, 쉼표, 물음표, 느낌표 등 글을 읽기 위한 기본 부호"),
        (19, "연산 기호와 실전 문장 읽기",
             "+, ÷ 등 간단한 연산 기호, 실생활 문장 구성"),
        (20, "실전 융합 점자 읽기",
