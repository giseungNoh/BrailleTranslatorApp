...
struct Day5View: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            CurriculumProgressBar(current: currentStep.rawValue, total: Day5Step.allCases.count)
        ...
        .environment(\.curriculumStepProgress, CurriculumStepProgress(current: currentStep.rawValue, total: Day5Step.allCases.count))
        .onAppear {
