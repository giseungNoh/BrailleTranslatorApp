...
struct Day14View: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            CurriculumProgressBar(current: currentStep.rawValue, total: Day14Step.allCases.count)
        ...
        .environment(\.curriculumStepProgress, CurriculumStepProgress(current: currentStep.rawValue, total: Day14Step.allCases.count))
        .onAppear {
