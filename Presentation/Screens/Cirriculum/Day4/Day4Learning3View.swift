...
struct Day4Learning3View: View {
    ...
    private let vowels: [VowelInfo] = [
        VowelInfo(name: "으", letter: "ㅡ", dotLabel: "2·4·6점"),
        VowelInfo(name: "이", letter: "ㅣ", dotLabel: "1·3·5점"),
    ]

    private let descriptionText = "가로로 누운 '으'와 세로로 선 '이'는\n점자에서 서로 좌우가 뒤집힌\n짝꿍 모양입니다.\n\nㅡ는 오른쪽 짝수 점(2·4·6점)\nㅣ는 왼쪽 홀수 점(1·3·5점)"
        ...
        GeometryReader { geo in
            ...
            VStack(spacing: 0) {
                Text("좌우 대칭 모음 ②")
                    ...
                    .accessibilityLabel("거울처럼 마주 보는 좌우 대칭 모음 2, 으와 이")
...
#Preview {
    Day4Learning3View(onNext: {}, onBack: {})
