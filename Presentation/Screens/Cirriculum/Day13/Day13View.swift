...
struct Day13View: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            CurriculumProgressBar(current: currentStep.rawValue, total: Day13Step.allCases.count)
        ...
        .environment(\.curriculumStepProgress, CurriculumStepProgress(current: currentStep.rawValue, total: Day13Step.allCases.count))
        .onAppear {
