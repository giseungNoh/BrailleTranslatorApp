...
let day6PushDescription = "점자에서 홑받침글자를 만드는\n첫 번째 핵심 원리는\n\"옆으로 밀 수 있으면 밀어라\"입니다.\n\n점자 칸의 오른쪽(4, 5, 6점)에 치우쳐 있어\n왼쪽으로 빈 공간이 있는\n'ㄱ, ㄹ, ㅂ, ㅅ, ㅈ, ㅊ'의 첫소리 점형은,\n모양을 그대로 유지한 채\n왼쪽으로 밀어서 홑받침글자를 만듭니다."

/// 설명뷰 1 아이템 — 첫소리 → 받침 변환을 다이어그램으로 표시
let day6PushItems: [BrailleLetterItem] = [
    BrailleLetterItem(name: "기역", letter: "ㄱ", dotLabel: "1점", fromDotLabel: "4점"),
    BrailleLetterItem(name: "리을", letter: "ㄹ", dotLabel: "2점", fromDotLabel: "5점"),
    BrailleLetterItem(name: "비읍", letter: "ㅂ", dotLabel: "1·2점", fromDotLabel: "4·5점"),
    BrailleLetterItem(name: "시옷", letter: "ㅅ", dotLabel: "3점", fromDotLabel: "6점"),
    BrailleLetterItem(name: "지읒", letter: "ㅈ", dotLabel: "1·3점", fromDotLabel: "4·6점"),
    BrailleLetterItem(name: "치읓", letter: "ㅊ", dotLabel: "2·3점", fromDotLabel: "5·6점"),
]
...
let day6DropDescription = "두 번째 핵심 원리는\n\"밀 수 없다면 아래로 내려라\"입니다.\n\n'ㄴ, ㄷ, ㅁ, ㅋ, ㅌ, ㅍ, ㅎ'은\n이미 1점(왼쪽) 자리를 차지하고 있거나\n위쪽에 매달려 있어 옆으로 밀 수 없습니다.\n\n이렇게 옆으로 밀 수 없는 글자들은\n점형을 아래로 한 칸 내려서\n홑받침글자를 만듭니다."

/// 설명뷰 2 아이템 — 첫소리 → 받침 변환을 다이어그램으로 표시
let day6DropItems: [BrailleLetterItem] = [
    BrailleLetterItem(name: "니은", letter: "ㄴ", dotLabel: "2·5점", fromDotLabel: "1·4점"),
    BrailleLetterItem(name: "디귿", letter: "ㄷ", dotLabel: "3·5점", fromDotLabel: "2·4점"),
    BrailleLetterItem(name: "미음", letter: "ㅁ", dotLabel: "2·6점", fromDotLabel: "1·5점"),
    BrailleLetterItem(name: "키읔", letter: "ㅋ", dotLabel: "2·3·5점", fromDotLabel: "1·2·4점"),
    BrailleLetterItem(name: "티읕", letter: "ㅌ", dotLabel: "2·3·6점", fromDotLabel: "1·2·5점"),
    BrailleLetterItem(name: "피읖", letter: "ㅍ", dotLabel: "2·5·6점", fromDotLabel: "1·4·5점"),
    BrailleLetterItem(name: "히읗", letter: "ㅎ", dotLabel: "3·5·6점", fromDotLabel: "2·4·5점"),
]
...
let day6IeungPracticeItems: [BrailleLetterItem] = [
    BrailleLetterItem(name: "아, 첫소리 이응은 생략", letter: "아", dotLabel: "ㅏ(1·2·6점)", cellsPerLine: 1),
    BrailleLetterItem(name: "앙, 받침 이응 2·3·5·6점", letter: "앙", dotLabel: "ㅏ + ㅇ받침(2·3·5·6점)", cellsPerLine: 2),
]
